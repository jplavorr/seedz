...
with concurrent.futures.ThreadPoolExecutor() as executor:
    ...
    executor.submit(create_weather_data, 'http://localhost:5000/api/create_weather', data_to_post)
    #executor.submit(get_weather_data, 'http://localhost:5000/api/weather')
    executor.submit(update_weather_data, f'http://localhost:5000/api/update_weather/{data_to_put["cod_city"]}', data_to_put)
    executor.submit(delete_weather_data, f'http://localhost:5000/api/delete_weather/{cod_city_to_delete}')
